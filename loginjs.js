...
loginForm.addEventListener('submit', (event) => {// Listen for the form submission
  ...
  if (username === 'admin' && password === 'password') {
    ...
    window.location.href = "Admin/admin.html";// Redirect the user to the admin page
  } else {
    // Redirect the user to the main page
    localStorage.setItem('userName', username);// Redirect the user to the main page
    window.location.href = 'Dashboard/dashboard.html';// Redirect the user to the main page
  }
}});